...
const priorities: { label: string; value: PriorityLevel | 'all' }[] = [{ label: 'All', value: 'all' }, { label: 'High', value: 'high' }, { label: 'Moderate', value: 'medium' }, { label: 'Normal', value: 'low' }];
